...
$in = mysqli_query($conexao,"insert into notas (nome,red,cn,ch,li,mat,arquitetura,direito,enfermagem,eng_civ,medicina)"
        . "values ('$nome',$RED,$CN,$CH,$LI,$MAT,$mediaARQ,$mediaDIR,$mediaENF,$mediaENG_CIV,$mediaMED)") or die("Erro");
